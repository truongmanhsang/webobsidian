...
- **Tương tác canvas** (parity Obsidian): **kéo chuột trái trên nền = marquee chọn nhiều node** (Shift = cộng dồn);
  **pan** = giữ Space + kéo, hoặc kéo nút giữa/phải; trên cảm ứng 1 ngón vẫn pan. Zoom bằng cuộn chuột (con trỏ
  làm tâm), nút zoom in/out/fit/100%. Lưới chấm nền.
